...
import { DollarSign, ArrowUpRight, CheckCircle2, History } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 p-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
           {payouts.map(p => (
              <div key={p.id} className="bg-slate-900/50 border border-slate-800 p-8 rounded-3xl flex items-center justify-between group">
